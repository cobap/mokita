...
// Components
import TabelaDebriefs from './../tabela/TabelaDebriefs';
    ...
    return (
      <div className={classes.root}>
        ...
        <Grid container justify="center">
          <Grid item xs={2} lg={2}>
            <TextField id="sso_tecnico" required label="SSO" variant="standard" className={classes.textField} value={this.state.sso_tecnico} onChange={this.handleChange('sso_tecnico')} margin="normal" />
            <Button className={classes.botaoplus} onClick={() => {this.buscarDebriefs()}} color="secondary"> Buscar </Button>
          </Grid>
          <Grid item xs={12} lg={12}> <TabelaDebriefs windfarm={this.state.windfarm} sso_tecnico={this.state._sso_tecnico} /> </Grid>
        </Grid>
